...
boite_horizontale = QHBoxLayout()
boite_horizontale.addWidget(QRadioButton("Catégorie 1"))
boite_horizontale.addWidget(QRadioButton("Catégorie 2"))
boite_horizontale.addStretch()

questionnaire.addRow(label4, boite_horizontale)
